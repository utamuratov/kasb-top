...
@Component({
    ...
    template: `
        <main class="bg-white">
            <section class="relative min-h-screen flex items-center bg-banner">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-transparent"
                ></div>
                <div class="relative w-full max-w-7xl mx-auto px-4 py-20">
                    <div class="max-w-2xl">
                        <h1
                            class="text-6xl font-bold text-gray-900 mb-6 leading-tight"
                        >
                            Kim bo'lsam <br />
                            <span class="text-primary">ekan?</span>
                        </h1>
                        <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                            O'z qobiliyatingizni kashf eting va kelajakda eng
                            mos kasbni toping. Professional testlar orqali
                            shaxsiy tavsiyalar oling.
                        </p>
                        <a
                            routerLink="/test"
                ...
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            >
                                <i
                                    class="ri-questionnaire-line text-primary text-2xl"
                                ></i>
                            </div>
                            <div
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Maxsus ishlab chiqilgan savollar orqali o'z
                                qiziqishlaringiz, qobiliyatlaringiz va shaxsiy
                                xususiyatlaringizni aniqlang.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                <i
                                    class="ri-key-2-line text-secondary text-2xl"
                                ></i>
                            </div>
                            <div
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Test yakunida maxfiy ID raqamingizni oling. Bu
                                raqamni saqlab qo'ying - u orqali
                                natijalaringizga murojaat qilasiz.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                <i
                                    class="ri-lightbulb-line text-orange-500 text-2xl"
                                ></i>
                            </div>
                            <div
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                ID raqamingiz orqali batafsil natijalarni
                                ko'ring va sizga mos kasblar bo'yicha
                                professional tavsiyalar oling.
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            ...
                                            faqat bir necha daqiqa vaqtingiz
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="py-20 bg-gradient-to-r from-primary to-blue-600">
                <div class="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                        Minglab yoshlar o'z yo'lini topdi. Endi sizning
                        navbatingiz!
                    </p>
                    <button
                        routerLink="/test"
                        class="cursor-pointer bg-white text-primary px-8 py-4 !rounded-button text-lg font-semibold hover:bg-gray-50 transition-colors whitespace-nowrap"
                    >
